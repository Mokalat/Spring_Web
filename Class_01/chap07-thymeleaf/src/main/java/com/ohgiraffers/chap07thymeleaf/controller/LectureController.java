...
public class LectureController {
    ...
    public ModelAndView conditional(ModelAndView mv) {
        ...
        memberDTOList.add(new MemberDTO("홍길순", 20, '여', "강서구"));
        memberDTOList.add(new MemberDTO("홍동길", 25, '남', "강남구"));
        memberDTOList.add(new MemberDTO("홍도윤", 29, '남', "강북구"));
        memberDTOList.add(new MemberDTO("홍목", 18, '여', "중구"));
        memberDTOList.add(new MemberDTO("홍보고", 26, '남', "남구 "));
