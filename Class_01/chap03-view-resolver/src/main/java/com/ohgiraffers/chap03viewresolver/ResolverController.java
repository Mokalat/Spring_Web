...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
        ...
        /*
            문자열로 뷰 이름을 반환하는 것은 반환 후
            ThyumeleafViewResolver에게 reources/template/를 prefix로 .html을 suffix로 하여
            resoutces/templates/result.html 파일로 응답 뷰를 설정하라는 의미가 된다
        */
        return "result";
    }
    ...
    public String stringRdirectFlashAttribute(RedirectAttributes rttr) {
        ...
        /*
            ...
            세션에 임시로 ㅅ값을 담고 소멸하는 방식이기 때문에 session에 동일한 키값이 존재하지 않아야한다
        */
    ...
    public ModelAndView modelandview(ModelAndView mv) {
        /*
            모델과 뷰를 합친 개념이다.
            핸들러 어댑터가 핸들러 메소드를 호출하고 반환받은 문자열을 modelandView로 만들어 dispatcherServler에 반환한다
            이 때 문자열을 반환해도 되지만 ModelAndView를 미리 만들어 반환 할 수 도 있다.
        */
